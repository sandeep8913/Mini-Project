...
<div class="container">
    <table>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td class="actions">
                    <a href="oemap.php?edit=<?php echo $row['id']; ?>">Edit</a>
                    <a href="oemap.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
    ...
    <div class="form-container">
        ...
        <form method="post" action="oemap.php">
