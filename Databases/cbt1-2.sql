...
CREATE TABLE `cse` (
  ...
  `MultiVariableCalculus` varchar(30) DEFAULT 'no',
  `DiscreteMathematics` varchar(30) DEFAULT 'no'
...
CREATE TABLE `ece` (
  `roll` tinytext DEFAULT NULL,
  `Physics` varchar(30) DEFAULT 'no',
  `Basic Electrical Engineering` varchar(30) DEFAULT 'no',
  `Multi Variable Calculus` varchar(30) DEFAULT 'no'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
